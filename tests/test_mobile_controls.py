...
class MobileControlsTests(unittest.TestCase):
    ...
    def test_short_portrait_layout_compacts_without_tiny_touch_targets(self):
        ...
        assert_html_contains(self, r'--touch-width:\s*88px', "short portrait keeps wider left and right D-pad buttons")
        assert_html_contains(self, r'--touch-vertical-width:\s*124px', "short portrait makes centered up and down buttons wider")
    ...
    def test_landscape_mobile_layout_places_controls_beside_canvas(self):
        ...
        assert_html_contains(self, r'--touch-width:\s*80px', "landscape keeps wider left and right D-pad buttons")
        assert_html_contains(self, r'--touch-vertical-width:\s*116px', "landscape makes centered up and down buttons wider")
    ...
    def test_mobile_controls_use_wider_dpad_with_saved_square_layout(self):
        ...
        assert_html_contains(self, r'--touch-width:\s*100px', "default mobile left and right D-pad buttons keep current width")
        assert_html_contains(self, r'--touch-vertical-width:\s*144px', "default mobile up and down D-pad buttons are wider than side buttons")
