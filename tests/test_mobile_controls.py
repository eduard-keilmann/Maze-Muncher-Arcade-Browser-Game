...
class MobileControlsTests(unittest.TestCase):
    ...
    def test_short_portrait_layout_compacts_without_tiny_touch_targets(self):
        ...
        assert_html_contains(self, r'--touch-width:\s*88px', "short portrait uses wider D-pad buttons")
    ...
    def test_landscape_mobile_layout_places_controls_beside_canvas(self):
        ...
        assert_html_contains(self, r'--touch-width:\s*80px', "landscape uses wider D-pad buttons")
    ...
    def test_mobile_controls_use_wider_dpad_with_saved_square_layout(self):
        ...
        assert_html_contains(self, r'--touch-width:\s*100px', "default mobile D-pad buttons are wider than tall")
        ...
        assert_html_contains(self, r'width:\s*var\(--touch-width\);[\s\S]*?height:\s*var\(--touch-height\);', "D-pad buttons use rectangular dimensions")
        assert_html_contains(self, r'Saved square D-pad layout:[^\n]*--touch-width:\s*var\(--touch-square-size\)[^\n]*--touch-wing-offset:\s*0px', "old square D-pad layout is documented for easy rollback")
