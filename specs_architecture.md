...
- JavaScript owns game state, input handling, update loop, collision/game rules, canvas rendering, and generated sound effects.
...
- Keep input adapters thin: keyboard, swipe, touch buttons, and sound toggle should call shared game actions such as direction, pause, sound, and new game.
...
- Sound effects should be generated with Web Audio; do not copy copyrighted arcade audio assets.
- Sound preference should stay local to the browser via localStorage.
...
- Do not add dependencies for basic layout, controls, generated sound, or simple static tests.
