...
- JavaScript owns game state, input handling, update loop, collision/game rules, and canvas rendering.
...
- Keep input adapters thin: keyboard, swipe, and touch buttons should call shared game actions such as direction, pause, and new game.
...
- Do not add dependencies for basic layout, controls, or simple static tests.
